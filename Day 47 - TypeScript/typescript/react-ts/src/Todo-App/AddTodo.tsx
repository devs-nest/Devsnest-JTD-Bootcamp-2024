...
import { TodoAppCtx, TodoDispatchCtx, TodosAppContext, TodosDispatchContext } from "./TodoApp";
...
export default function AddTodo() {
    ...
    const todosDispatchContext: TodoDispatchCtx = useContext(TodosDispatchContext) as TodoDispatchCtx;
    ...
    function onTodoAdd(text: string) {
        ...
        todosDispatchContext.dispatch({ type: 'add', todo: { id: newId, text, done: false } });
    }
